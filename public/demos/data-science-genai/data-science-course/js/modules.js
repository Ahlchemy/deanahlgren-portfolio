        ...
        <div class="section active" data-section="0">
            <div class="section-header">
                ...
                <p class="section-description">
                    ...
                    based on data observation and pattern recognition.
                </p>
            </div>
            ...
            <div class="content-grid">
                <div class="content-card hover-lift">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">When to Stock Firewood?</h3>
                    </div>
                    <div class="card-content">
                        <p>Ancient communities observed seasonal patterns, temperature changes, and weather indicators to determine optimal times for gathering and storing firewood. This required:</p>
                        <ul>
                            <li>Historical weather pattern analysis</li>
                            <li>Resource availability assessment</li>
                            <li>Community consumption rate calculations</li>
                            <li>Storage capacity optimization</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="content-card hover-lift">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Best Time to Travel?</h3>
                    </div>
                    <div class="card-content">
                        <p>Travel decisions were based on multiple data inputs including geography, weather predictions, and seasonal factors:</p>
                        <ul>
                            <li><strong>Geography:</strong> Terrain difficulty and route safety</li>
                            <li><strong>Weather:</strong> Rainfall patterns and temperature</li>
                            <li><strong>Pressure:</strong> Atmospheric indicators</li>
                            <li><strong>Humidity:</strong> Comfort and health considerations</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="content-card hover-lift">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">When to Cultivate Crops?</h3>
                    </div>
                    <div class="card-content">
                        <p>Agricultural decisions required sophisticated data analysis of multiple environmental factors:</p>
                        <ul>
                            <li>Soil moisture and nutrient levels</li>
                            <li>Seasonal rainfall predictions</li>
                            <li>Temperature cycle analysis</li>
                            <li>Pest and disease pattern recognition</li>
                        </ul>
                    </div>
                </div>
